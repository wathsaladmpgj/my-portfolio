  ...
  const certifications = [
    {
      ...
      badge: 'https://via.placeholder.com/200/ff7300/ffffff?text=AWS',
    },
    {
    ...
    },
    {
      ...
      issuer: 'CNCF',
      date: '2023',
      description: 'Skills in deploying and managing Kubernetes clusters',
      badge: 'https://via.placeholder.com/200/ff7300/ffffff?text=K8s',
    },
    {
      title: 'CCNA - Cisco Certified Network Associate',
      issuer: 'Cisco',
      date: '2022',
      description: 'Foundation in networking concepts and Cisco technologies',
      badge: 'https://via.placeholder.com/200/ff7300/ffffff?text=CCNA',
    },
    {
      title: 'Linux Professional Institute',
      issuer: 'LPI',
      date: '2022',
      description: 'Expertise in Linux system administration',
      badge: 'https://via.placeholder.com/200/ff7300/ffffff?text=Linux',
    },
    {
      title: 'GitHub Actions Certified',
      issuer: 'GitHub',
      date: '2023',
      description: 'Advanced CI/CD workflows and automation',
      badge: 'https://via.placeholder.com/200/ff7300/ffffff?text=GitHub',
    },
  ];
